...
CREATE TABLE doctorlist (
    ...
    eduction NVARCHAR(100) NOT NULL,
...
FOR EACH ROW
BEGIN
	INSERT INTO doctorinfo (name,address,phone,eduction,position,hospital)
		VALUES (new.name, new.address, NEW.phone,NEW.eduction,NEW.position,NEW.hospital);
END//
#DELIMITER;
